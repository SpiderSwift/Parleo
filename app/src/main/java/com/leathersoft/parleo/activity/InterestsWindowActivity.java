...
public class InterestsWindowActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Interest> listInterests = (List<Interest>) i.getSerializableExtra("listInterests");
        adapter.setInterests(listInterests);
        recyclerView.setAdapter(adapter);
        Button b = findViewById(R.id.btn_done);
        b.setOnClickListener(view -> {
            Intent intent = new Intent();
            intent.putExtra("listInterests", (Serializable) listInterests);
